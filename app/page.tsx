    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  'Choose fonts, colors, and layout that match your personality',
              },
              {
                icon: '💼',
            ...
            {[
              {
                ...
                description:
                  'Create CVs that look like they were designed by career experts',
              },
              {
                title: 'ATS Optimized',
                description:
                  'Our formatting ensures applicant tracking systems can read your CV properly',
              },
              {
                title: 'Time Saving',
              ...
              },
              {
                ...
                description:
                  'Get notified when your CV needs refreshing with our smart suggestions',
              },
            ].map((benefit, index) => (
              <motion.div
                key={index}
            ...
            {[
              {
                ...
                quote:
                  'Creative CV helped me land 3 interviews in my first week of applying. The clean design made my experience stand out.',
              },
              {
                name: 'Michael Chen',
                role: 'Software Engineer',
                quote:
                  "As a recent graduate, I was struggling to get noticed. Creative CV's professional layout finally got me the responses I wanted.",
              },
      ...
      <section className="py-16 bg-blue-600 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            Join thousands of professionals who improved their job prospects
            with Creative CV
          </motion.p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="mb-4">
                Create professional resumes that get you hired faster with our
